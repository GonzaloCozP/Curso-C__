...
int main(){
    ...
    */
    ...
    //declara la variable "contar" que guarda la cantidad que se repite un numero
    int contar;
    //cuantas veces se repite un numero
    for(int i=0;i<tamaño;i++){
        //inciamos en cero porque se va a sumar 1 cuando se cuente asi misma
        contar=0;
        for(int y=0;y<tamaño;y++){ 
            //si encuentra un numero que se repita suma 1 a la variable contar
            if(num[i]==num[y]){
                contar=contar+1;
            } else {
                contar=contar;
